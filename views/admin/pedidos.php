...
<div id="test2">
  ...
  <div id="info">
    ...
    <div class="col l9 m7 s12">
      <div class="card" style="" id="tit">
        <div class="card-content black-text">
        <span class="card-title">Información</span>
        <p>Seleccione una fecha de pedido en el panel derecho para poder visualizar el contenido</p>
    ...
    <div class="col l9 m7 s12" id="tp2">

      
      <table class="responsive row-border dt-head-center" width="100%" cellspacing="0" id="tabla_pendientes">
        <thead>
          <tr>
...
<div class="col l3 m5 s12">
    ...
    <div id="titulo_ticket" class="borde row" style="background-color: #0D163C;"> <!-- Abre titulo de nuevo producto -->
      <div class="col l6 m6" style="margin-top:3%">
              <label style="font-size: 1em; margin-left: 2%;">Pedidos pendientes</label>
      </div>

      <div class="col l6 m6">
        <a type="" id="bt_guardar_autorizacion" class="btn col right green" style="background: #88603F; margin-top:5%; margin-bottom:5%; margin-right:2%">
            <i class="material-icons">send</i>
        </a>

        <a type="" id="bt_cerrar_autorizacion" class="btn col right red" style="background: #D6E055; margin-top:5%; margin-bottom:5%; margin-right:2%">
                <i class="material-icons">close</i>
        </a>
      </div>
    ...
    <div class="collection" id="tabla_fechas">
...
if(li_p==1)
{
	$("#li_reg").removeClass('activa');
	$("#li_pedidos").addClass('activa');
}
